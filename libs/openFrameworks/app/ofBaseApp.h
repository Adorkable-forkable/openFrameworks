...
class ofBaseApp : public ofBaseSoundInput, public ofBaseSoundOutput{
	...
	public:
		...
		virtual void mouseMoved( ofMouseEventArgs & mouse ){
			mouseX=(int)mouse.x;
			mouseY=(int)mouse.y;
			mouseMoved((int)mouse.x,(int)mouse.y);
		}
		virtual void mouseDragged( ofMouseEventArgs & mouse ){
			mouseX=(int)mouse.x;
			mouseY=(int)mouse.y;
			mouseDragged((int)mouse.x,(int)mouse.y,mouse.button);
		}
		virtual void mousePressed( ofMouseEventArgs & mouse ){
			mouseX=(int)mouse.x;
			mouseY=(int)mouse.y;
			mousePressed((int)mouse.x,(int)mouse.y,mouse.button);
		}
		virtual void mouseReleased(ofMouseEventArgs & mouse){
			mouseX=(int)mouse.x;
			mouseY=(int)mouse.y;
			mouseReleased((int)mouse.x,(int)mouse.y,mouse.button);
		}
